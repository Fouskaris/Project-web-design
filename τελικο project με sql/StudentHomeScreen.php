...
<style>
  ...
  .pic {
    width: 100%;
    max-width: 600px;   /* πιο μεγάλο πλαίσιο εικόνας */
    height: auto;
    border-radius: 15px;
    object-fit: cover;  /* χωρίς παραμόρφωση */
  }

  .menu {
    flex: 0.7;          /* πιο μικρό πλαίσιο επιλογών */
    background: white;
    padding: 1em 2em;
    border-radius: 12px;
    box-shadow: 0 2px 6px rgba(0,0,0,0.1);
...
<div class="bottom-menu">
  <a class="footer-button helpdesk-button" href="https://helpdesk.upnet.gr/" target="_blank">Επικοινωνία με Helpdesk</a>
