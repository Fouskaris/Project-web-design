...
$studentData = json_decode(file_get_contents($json_file), true);
...
if ($studentFound) {
    ...
    echo "<div class='container'><p>Δεν βρέθηκε φοιτητής με ID: <strong>$id</strong>.</p></div>";
}
?>
...
if (empty($studentFound['notifications'])) {
    ...
    foreach ($studentFound["notifications"] as &$notif) {
        ...
        $professors = $studentData['professors'];
