...
<h1 class="h1file">Ανέβασμένα Αρχεία:</h1>
<?php $jsonString= file_get_contents("dipl.json");
  $data= json_decode($jsonString,true);
  $subjects = $data['subjects']; 
  $id=0;
  foreach($subjects as $subject){ ;
    if ($subjects['student_number']==$stud_num){
      $subj_id = $subject['id']; }
  }
  if($id==0){}
  ?>
...
<button class='AddFileSpace' onclick='addFileInput()'><svg xmlns='http://www.w3.org/2000/svg' width='32' height='32' fill='currentColor' class='bi bi-plus-square' viewBox='0 0 16 16'>
  <path d='M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z'/>
  <path d='M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4'/>
</svg></button></div>
  <form action='upload.php'method='post' enctype='multipart/form-data' style='margin-top:2em; text-align:center; font-size:30px;'>
  <div id="fileInputs"> 
  <label for='myfile'>1.</label>
