...
$data = json_decode(file_get_contents("dipl.json"), true);
...
echo "<h1 style='margin-left:auto;margin-top:5em;'>Επιτυχής Ανέβασμα Αρχείων</h1>  ";
}else{echo "<h1 style='margin-left:auto;margin-top:5em;'>Δεν πραγματοποιήθηκε το Ανέβασμα Αρχείων</h1>  ";
}
?>
