...
<h1 class="depclasstext">Κείμενο</h1>
  ...
  ?>
  <form class="diplForm" style="text-align: center;" method="POST" >
    <div class="wrapper">
    ...
    if($dep!="Εισάγετε τμήμα πρώτα!"){  $jsonString = file_get_contents("export.json");
        ...
        if($ok==1){echo "<h2>Αίτημα καθηγητών τμήματος $dep</h2>";
          ...
          foreach ($professors as $professor) {
            if ($professor['department']==$dep){
              ...
              echo "<tr>
                ...
                <td><label>
                <input type='checkbox' name='option$counter'  value='yes'>
                </label></td>
              </tr>";
            }}
  ...
  <form class="diplForm" style="text-align: center;" method="POST" >
    ...
    <div class="onHover">
      ...
      <label for="cars">&nbsp;&nbsp;&nbsp;Ώρα:</label>
      <select class="exDate" id="cars">
    ...
    <button class="submBu" id="finalSub" type="submit" >Υποβολή Ημερομηνίας</button>
</form>
